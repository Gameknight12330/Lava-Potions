...
import com.projectmushroom.lavapotions.screen.slot.ModResultSlot;
...
public class LavaBrewingCauldronMenu extends AbstractContainerMenu {
	...
	public LavaBrewingCauldronMenu(int containerID, Inventory inv, BlockEntity entity) {
		...
		this.blockEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(handler -> {
            this.addSlot(new SlotItemHandler(handler, 0, 69, 19));
            this.addSlot(new SlotItemHandler(handler, 1, 88, 18));
            this.addSlot(new SlotItemHandler(handler, 2, 107, 18));
            this.addSlot(new ModResultSlot(handler, 3, 69, 69));
            this.addSlot(new ModResultSlot(handler, 4, 88, 69));
            this.addSlot(new ModResultSlot(handler, 5, 107, 69));
        });
	}
