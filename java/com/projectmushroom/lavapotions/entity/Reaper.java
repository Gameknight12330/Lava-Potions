...
public class Reaper extends Monster implements PowerableMob, RangedAttackMob {
	   ...
	   protected void registerGoals() {
	      this.goalSelector.addGoal(0, new Reaper.WitherDoNothingGoal());
	      this.goalSelector.addGoal(2, new RangedAttackGoal(this, 2.0D, 20, 40.0F));
