...
import com.projectmushroom.lavapotions.block.custom.ModStandingSignBlock;
import com.projectmushroom.lavapotions.block.custom.ModWallSignBlock;
...
//	-----------------------------------------------------------------------------------------------------------
	...
	public static final RegistryObject<Block> DEAD_OAK_WALL_SIGN = registerBlockWithoutBlockItem("dead_oak_wall_sign",
            () -> new ModWallSignBlock(BlockBehaviour.Properties.copy(Blocks.OAK_WALL_SIGN), ModWoodTypes.DEAD_OAK));

    public static final RegistryObject<Block> DEAD_OAK_SIGN = registerBlockWithoutBlockItem("dead_oak_sign",
            () -> new ModStandingSignBlock(BlockBehaviour.Properties.copy(Blocks.OAK_SIGN), ModWoodTypes.DEAD_OAK));
