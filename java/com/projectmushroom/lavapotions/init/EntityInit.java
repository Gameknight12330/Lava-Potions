...
public final class EntityInit {
    ...
    public static final RegistryObject<EntityType<LavaThrownStairway>> LAVA_THROWN_STAIRWAY = ENTITIES.register("lava_thrown_stairway",
    		() -> EntityType.Builder.of((EntityType.EntityFactory<LavaThrownStairway>) LavaThrownStairway::new, MobCategory.MISC)
    		.sized(0.25F, 0.25F).clientTrackingRange(4).updateInterval(10)
    		.build("lava_thrown_scalding"));
